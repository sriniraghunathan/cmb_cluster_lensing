...
for (cluster_mass, cluster_z) in zip(cluster_mass_arr, cluster_z_arr):
    ...
    op_folder = misc.get_op_folder(results_folder, nx, dx, beamval, noiseval, cutout_size_am, ilc_file=ilc_file, which_ilc = which_ilc, nclustersorrandoms = total_clusters, pol = pol, models = True, fg_str = fg_str)
